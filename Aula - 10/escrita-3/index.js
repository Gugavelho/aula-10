...
let respostaP = prompt("Diga uma tarefa que você precisa realizar no dia.")
let respostaS = prompt("Diga outra.")
let respostaT = prompt("Diga mais uma.")

listaDeTarefas.push(respostaP,respostaS,respostaT)

console.log(listaDeTarefas)

let tarefaRemovida = prompt("digite o número 1, 2 ou 3 para remover a tarefa que você ja realizou hoje.")

tarefaRemovida = Number(tarefaRemovida)

listaDeTarefas.splice(tarefaRemovida, 1)
